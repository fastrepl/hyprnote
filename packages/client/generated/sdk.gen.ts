...
import type { GetHealthData, GetApiDesktopUserIntegrationsData, GetApiDesktopUserIntegrationsResponse, PostApiWebConnectData, PostApiWebConnectResponse, GetApiWebCheckoutData, GetApiWebSessionByIdData, GetApiWebSessionByIdResponse, PostApiWebIntegrationConnectionData, PostApiWebIntegrationConnectionResponse, PostChatCompletionsData } from './types.gen';
...
export const getApiWebCheckout = <ThrowOnError extends boolean = false>(options?: Options<GetApiWebCheckoutData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
