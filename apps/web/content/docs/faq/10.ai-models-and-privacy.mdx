...
Hyprnote integrates with external LLM providers like [LM Studio](https://lmstudio.ai) and [Ollama](https://ollama.ai) for AI features like summaries and note generation. This gives you flexibility to choose the model that best fits your needs.
