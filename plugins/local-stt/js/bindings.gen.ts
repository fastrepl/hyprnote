...
async getServer() : Promise<ServerType | null> {
    return await TAURI_INVOKE("plugin:local-stt|get_server");
},
async startServer(t: ServerType | null) : Promise<string> {
    return await TAURI_INVOKE("plugin:local-stt|start_server", { t });
},
