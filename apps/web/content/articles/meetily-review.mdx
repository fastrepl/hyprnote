...
![Meetily's local processing pipeline from system audio to meeting summary](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/articles/meetily-review/meetily-pipeline.png)
