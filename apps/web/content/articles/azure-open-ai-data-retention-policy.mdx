...
![Where prompts go in Azure OpenAI: the default abuse-monitoring path and the approved zero-retention path](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/articles/azure-open-ai-data-retention-policy/azure-openai-data-flow.png)
