...
![ChatGPT data handling across consumer plans, business plans, and the API](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/articles/chatgpt-data-retention-policy/chatgpt-retention-by-plan.png)
