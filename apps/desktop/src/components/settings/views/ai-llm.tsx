...
export default function LlmAI() {
  ...
  }, [providerSourceQuery.data, customLLMEnabled.data, openAccordion, hyprCloudEnabled.data, othersApiBaseQuery.data, setOpenAccordion, setOthersApiBaseMutation]);
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription className="text-xs">
                            {(!customLLMEnabled.data || hyprCloudEnabled.data) ? <Trans>Only works with Custom Endpoints. Please configure one of the above first.</Trans> : <Trans>Control how autonomous the AI enhancement should be.</Trans>}
                          </FormDescription>
                          <FormControl>
                                  ...
                                  {[1, 2, 3, 4].map((level) => (
                                    <button
                                      ...
                                      className={cn(
                                        ...
                                        (!customLLMEnabled.data || hyprCloudEnabled.data) && "opacity-50 cursor-not-allowed",
                                      )}
                                    >
