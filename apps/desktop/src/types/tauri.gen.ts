...
export const commands = {
  ...
  async getSelectedMicrophoneDevice(): Promise<string | null> {
    return await TAURI_INVOKE("get_selected_microphone_device");
  },
  async setSelectedMicrophoneDevice(deviceName: string | null): Promise<null> {
    return await TAURI_INVOKE("set_selected_microphone_device", { deviceName });
  },
  async checkMicrophoneAccess(): Promise<boolean> {
    return await TAURI_INVOKE("check_microphone_access");
  },
  async checkSystemAudioAccess(): Promise<boolean> {
    return await TAURI_INVOKE("check_system_audio_access");
  },
  async requestMicrophoneAccess(): Promise<null> {
    return await TAURI_INVOKE("request_microphone_access");
  },
  async requestSystemAudioAccess(): Promise<null> {
    return await TAURI_INVOKE("request_system_audio_access");
  },
  async openMicrophoneAccessSettings(): Promise<null> {
    return await TAURI_INVOKE("open_microphone_access_settings");
  },
  async openSystemAudioAccessSettings(): Promise<null> {
    return await TAURI_INVOKE("open_system_audio_access_settings");
  },
  async getMicMuted(): Promise<boolean> {
    return await TAURI_INVOKE("get_mic_muted");
  },
  async setMicMuted(muted: boolean): Promise<null> {
    return await TAURI_INVOKE("set_mic_muted", { muted });
  },
  async getSpeakerMuted(): Promise<boolean> {
    return await TAURI_INVOKE("get_speaker_muted");
  },
  async setSpeakerMuted(muted: boolean): Promise<null> {
    return await TAURI_INVOKE("set_speaker_muted", { muted });
  },
  async startSession(sessionId: string): Promise<null> {
    return await TAURI_INVOKE("start_session", { sessionId });
  },
  async stopSession(): Promise<null> {
    return await TAURI_INVOKE("stop_session");
  },
  async pauseSession(): Promise<null> {
    return await TAURI_INVOKE("pause_session");
  },
  async resumeSession(): Promise<null> {
    return await TAURI_INVOKE("resume_session");
  },
