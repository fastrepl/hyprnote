...
![An OpenRouter request passes through the gateway, then the underlying provider's own retention policy applies](https://ijoptyyjrfqwaqhyxkxj.supabase.co/storage/v1/object/public/blog/articles/openrouter-data-retention-policy/openrouter-request-path.png)
