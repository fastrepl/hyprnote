          ...
          >
            ...
            <div className="pt-6">
              <div className="space-y-3 text-sm">
                <div>
                  <p className="text-stone-900 font-medium">What do we talk about?</p>
                  <p className="text-stone-600 mt-1">
                    Your workflow, what you'd use Hyprnote for, and what matters most to you in a note-taking app.
                  </p>
                </div>

                <div>
                  <p className="text-stone-900 font-medium">Do you screen who books?</p>
                  <p className="text-stone-600 mt-1">
                    Yes — we're looking for people genuinely excited about Hyprnote, not just trying to skip the line.
                  </p>
                </div>
              </div>
            </div>
