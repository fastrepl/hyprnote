...
export const readStableSharedNote = <ThrowOnError extends boolean = false>(options: Options<ReadStableSharedNoteData, ThrowOnError>) => (options.client ?? client).get<ReadStableSharedNoteResponses, ReadStableSharedNoteErrors, ThrowOnError>({ url: '/shared-notes/share/{share_id}', ...options });

export const downloadStableSharedAttachment = <ThrowOnError extends boolean = false>(options: Options<DownloadStableSharedAttachmentData, ThrowOnError>) => (options.client ?? client).post<DownloadStableSharedAttachmentResponses, DownloadStableSharedAttachmentErrors, ThrowOnError>({ url: '/shared-notes/share/{share_id}/attachments/{attachment_id}/download', ...options });

export const createStableSharedNoteHandoff = <ThrowOnError extends boolean = false>(options: Options<CreateStableSharedNoteHandoffData, ThrowOnError>) => (options.client ?? client).post<CreateStableSharedNoteHandoffResponses, CreateStableSharedNoteHandoffErrors, ThrowOnError>({ url: '/shared-notes/share/{share_id}/handoff', ...options });

export const readStableSharedNotePreview = <ThrowOnError extends boolean = false>(options: Options<ReadStableSharedNotePreviewData, ThrowOnError>) => (options.client ?? client).get<ReadStableSharedNotePreviewResponses, ReadStableSharedNotePreviewErrors, ThrowOnError>({ url: '/shared-notes/share/{share_id}/preview', ...options });
...
export const patchDevice = <ThrowOnError extends boolean = false>(options: Options<PatchDeviceData, ThrowOnError>) => (options.client ?? client).patch<PatchDeviceResponses, PatchDeviceErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/sync/devices/{fingerprint}',
    ...options,
    headers: {
...
export const sendWorkspaceInvitationEmail = <ThrowOnError extends boolean = false>(options: Options<SendWorkspaceInvitationEmailData, ThrowOnError>) => (options.client ?? client).post<SendWorkspaceInvitationEmailResponses, SendWorkspaceInvitationEmailErrors, ThrowOnError>({
