...
There is no global switch for sharing emails because Anarlog does not send them automatically. If you open or close the panel without submitting **Invite** or **Email**, nothing is sent.
