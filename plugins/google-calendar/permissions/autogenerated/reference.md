...
`google-calendar:deny-add-google-account`
...
Enables the get_connected_accounts command without any pre-configured scope.
...
`google-calendar:allow-remove-google-account`
