...
- [Hyprnote](https://github.com/fastrepl/char) is open-source desktop app for meeting notes.
...
- Most of the code mentioned in this article is located in [plugins/listener/src](https://github.com/fastrepl/char/tree/main/plugins/listener/src).
