...
export const commands = {
  ...
  async toggleCalendarSelected(trackingId: string): Promise<Calendar> {
    return await TAURI_INVOKE("plugin:db|toggle_calendar_selected", {
      trackingId,
    });
  },
  ...
  async setSessionEvent(
    ...
    return await TAURI_INVOKE("plugin:db|set_session_event", {
      sessionId,
      eventId,
    });
  },
  async sessionAddParticipant(
    ...
    return await TAURI_INVOKE("plugin:db|session_add_participant", {
      sessionId,
      humanId,
    });
  },
  async sessionRemoveParticipant(
    ...
    return await TAURI_INVOKE("plugin:db|session_remove_participant", {
      sessionId,
      humanId,
    });
  },
  async sessionListParticipants(sessionId: string): Promise<Human[]> {
    return await TAURI_INVOKE("plugin:db|session_list_participants", {
      sessionId,
    });
  },
  ...
  async getOrganizationByUserId(userId: string): Promise<Organization | null> {
    return await TAURI_INVOKE("plugin:db|get_organization_by_user_id", {
      userId,
    });
  },
  async upsertOrganization(organization: Organization): Promise<Organization> {
    return await TAURI_INVOKE("plugin:db|upsert_organization", {
      organization,
    });
  },
  ...
  async listOrganizationMembers(organizationId: string): Promise<Human[]> {
    return await TAURI_INVOKE("plugin:db|list_organization_members", {
      organizationId,
    });
  },
  ...
  async assignTagToSession(tagId: string, sessionId: string): Promise<null> {
    return await TAURI_INVOKE("plugin:db|assign_tag_to_session", {
      tagId,
      sessionId,
    });
  },
  async unassignTagFromSession(
    ...
    return await TAURI_INVOKE("plugin:db|unassign_tag_from_session", {
      tagId,
      sessionId,
    });
  },
  ...
  async suggestTagsForSession(sessionId: string): Promise<string[]> {
    return await TAURI_INVOKE("plugin:db|suggest_tags_for_session", {
      sessionId,
    });
  },
};
