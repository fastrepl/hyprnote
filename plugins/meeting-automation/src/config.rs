    ...
    fn default() -> Self {
        Self {
            ...
            supported_apps: vec![
                ...
                "com.logmein.GoToWebinar".to_string(),
                "com.ringcentral.RingCentral".to_string(),
                "com.bluejeans.bluejeans".to_string(),
                "com.8x8.meet".to_string(),
                "com.jitsi.meet".to_string(),
            ],
