...
- On Basic, you can only *see* the last 30 days. The files are still there. See [Granola pricing](/blog/granola-ai-pricing).
...
Anarlog's answer to the last point is boring on purpose. Notes live in a local SQLite database. Models are ones you configure. There is no silent cloud default and no 30-day lock on your own text. That does not erase consent law. You still have to tell the room. It does erase "the vendor has the corpus and the training toggle was on."

## Related

- [Why people complain about Granola](/blog/granola-ai-complaints)
- [Granola pricing and the 30-day wall](/blog/granola-ai-pricing)
