...
The LLM endpoint uses OpenRouter to provide access to multiple AI models from providers including OpenAI, Anthropic, Google, and Mistral. Your requests are proxied through our servers with automatic API key management.
...
- Current providers: OpenAI, Anthropic, Google, Mistral (via OpenRouter), Exa (web search), Jina AI (URL reading)

All requests are rate-limited and authenticated using your Pro license key.
