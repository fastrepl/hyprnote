...
export type GetSessionFilter = { id: string } | { calendarEventId: string } | { tagId: string } | { daily: { date: string; user_id: string } }
...
export type Session = { id: string; created_at: string; visited_at: string; user_id: string; calendar_event_id: string | null; title: string; raw_memo_html: string; enhanced_memo_html: string | null; conversations: ConversationChunk[]; is_meeting: boolean }
