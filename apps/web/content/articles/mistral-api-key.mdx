...
![Mistral Studio API Keys page with the Create new key button highlighted](/images/blog/library/products/mistral/console/2026-09-08-api-keys-create-button.png)
...
![Mistral's create new API key dialog with name and expiration fields](/images/blog/library/products/mistral/console/2026-09-08-create-key-modal.png)
Source: [Mistral Docs, Activate Studio and generate an API key](https://docs.mistral.ai/getting-started/quickstarts/studio/activate-and-generate-api-key/), captured September 2026
