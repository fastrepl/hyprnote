...
export const Route = createFileRoute("/_view/solution/enterprise")({
  component: Component,
  head: () => ({
    meta: [
      ...
      {
        property: "og:url",
        content: "https://hyprnote.com/solution/enterprise",
      },
    ],
  }),
});
      ...
      <div className="px-6 py-12 lg:py-20">
        <header className="mb-8 text-center max-w-4xl mx-auto">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/founders/"
              search={{ source: "enterprise-solution" }}
              className={cn([
  ...
  return (
    <section className="px-6 py-16 bg-amber-50/50 border-t border-neutral-100">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <Link
          to="/founders/"
          search={{ source: "enterprise-solution-cta" }}
          className={cn([
            "inline-flex items-center gap-2 px-8 py-3 text-base font-medium rounded-full",
            "bg-linear-to-t from-stone-600 to-stone-500 text-white",
            "hover:scale-105 active:scale-95 transition-transform",
