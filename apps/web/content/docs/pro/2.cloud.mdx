...
The LLM endpoint supports multiple providers including OpenAI, Anthropic, Google, and Mistral. Your requests are proxied through our servers with automatic API key management.
...
- Current providers: OpenAI (via OpenRouter), Exa (web search), Jina AI (URL reading)
