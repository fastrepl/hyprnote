...
export const commands = {
  async getSelectedMicrophoneDevice(): Promise<MicrophoneDeviceInfo> {
    return await TAURI_INVOKE("plugin:listener|get_selected_microphone_device");
  },
  async setSelectedMicrophoneDevice(deviceName: string | null): Promise<null> {
    return await TAURI_INVOKE(
      "plugin:listener|set_selected_microphone_device",
      { deviceName },
    );
  },
  ...
  async openMicrophoneAccessSettings(): Promise<null> {
    return await TAURI_INVOKE(
      "plugin:listener|open_microphone_access_settings",
    );
  },
  async openSystemAudioAccessSettings(): Promise<null> {
    return await TAURI_INVOKE(
      "plugin:listener|open_system_audio_access_settings",
    );
  },
...
export type SessionEvent =
  ...
  | { type: "audioAmplitude"; mic: number; speaker: number }
  | { type: "micMuted"; value: boolean }
  | { type: "speakerMuted"; value: boolean };
