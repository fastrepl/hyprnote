...
export type ConfigGeneral = { autostart: boolean; display_language: string; jargons: string[]; telemetry_consent: boolean; save_recordings: boolean | null; selected_microphone_device: string | null; selected_template_id: string | null }
