...
export const commands = {
    ...
    try {
      return {
        ...
        data: await TAURI_INVOKE(
          "plugin:apple-calendar|open_calendar_access_settings",
        ),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
  ...
  async openContactsAccessSettings(): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "plugin:apple-calendar|open_contacts_access_settings",
        ),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
  ...
  async syncCalendars(): Promise<Result<null[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:apple-calendar|sync_calendars"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async syncEvents(filter: null): Promise<Result<null[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("plugin:apple-calendar|sync_events", {
          filter,
        }),
      };
    } catch (e) {
